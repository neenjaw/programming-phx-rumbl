defmodule RumblWeb.VideoControllerTest do
  ...
  test "restricts actions on videos by other users", %{conn: conn} do
  ...
  describe "with a logged-in user" do
    ...
    test "lists all user's videos on index", %{conn: conn, user: user} do
      ...
      assert String.contains?(response, "Listing Videos")
      assert String.contains?(response, user_video.title)
      refute String.contains?(response, other_video.title)
    end
